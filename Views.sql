...
(
SELECT DIM_CUSTOMER_ID, DIM_LOCATION_ID, CUSTOMER_ID, FULL_NAME, FIRST_NAME, LAST_NAME, GENDER, EMAIL_ID, PHONE_NUMBER
FROM DIM_CUSTOMER  
);
...
(
SELECT DIM_STORE_ID, DIM_RESELLER_ID, DIM_CHANNEL_ID, DATE_PKEY, SALES_TARGET_AMOUNT
